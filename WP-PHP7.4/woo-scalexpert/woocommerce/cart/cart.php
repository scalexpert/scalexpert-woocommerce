...
echo esc_url(wc_get_cart_url()); ?>" method="post">
    ...
    <?php if (!empty($blocposition) && $blocposition['blocposition_cart'] === 'over') {
        echo '<div class="sep-Simulations-Cart">';
        $productController->showSimulation4Cart($price);
        echo '</div>';
    } ?>
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
        ...
        foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
            ...
            if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', TRUE, $cart_item, $cart_item_key)) {
                ...
                echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                    ...
                    <td class="product-price" data-title="<?php
                    ...
                    <td class="product-quantity" data-title="<?php
                    ...
                    <td class="product-subtotal" data-title="<?php
        ...
        <tr>
            <td colspan="6" class="actions">
                ...
                if (wc_coupons_enabled()) { ?>
                    <div class="coupon">
                        <label for="coupon_code"><?php
                            esc_html_e('Coupon:', 'woocommerce'); ?></label> <input type="text"
                                                                                    name="coupon_code"
                                                                                    class="input-text"
                        ...
                        esc_attr_e('Apply coupon', 'woocommerce'); ?>"><?php
                            esc_attr_e('Apply coupon', 'woocommerce'); ?></button>
                        <?php
                ...
                <button type="submit" class="button" name="update_cart" value="<?php
        ...
        <?php if (!empty($blocposition) && $blocposition['blocposition_cart'] === 'under') { ?>
            <tr>
                <td id="simInCart" colspan="6">
                    <?php
                    $productController->showSimulation4Cart($price);
                    ?>
                </td>
