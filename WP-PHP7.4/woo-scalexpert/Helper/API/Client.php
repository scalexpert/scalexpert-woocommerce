<?php
    ...
    use GuzzleHttp;
    use wooScalexpert\Controller\Front\ProductController;
    ...
    class Client {
        ...
        /**
         * @param null $eFinancingAmount
         * @param string $eFinancingCountry
         * @param array $solution
         * @return array
         */
        public function getSimulateFinancing4Cart($eFinancingAmount, string $eFinancingCountry = "FR", array $solution = []): ?array
        {
