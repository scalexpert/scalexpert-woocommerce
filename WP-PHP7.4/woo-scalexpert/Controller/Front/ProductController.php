<?php
    ...
    class ProductController {
         ...
         * @return void
         */
        public function showSimulation4Cart( $price = NULL ) {
            $this->apiclient = new Client();
            ...
            $designData  = $this->formatter->buildDesignData( $eligibleSimulations, $solutions, FALSE, TRUE );
            $simulations = $this->formatter->normalizeSimulations( $simulationCart, $designData[ 'designSolutions' ], FALSE, TRUE );
         ...
         * @return false|mixed
         */
        public function eligibleSolutions4Cart( $solutions = array() ){
