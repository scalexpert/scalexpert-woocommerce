...
if (SCALEXPERT_SHOWSOLUTIONS) {
    ...
    if (!empty($blocposition) && $blocposition['blocposition'] === 'under') {
        echo $productController->showActifSolutions('product-buttons', 'under', $product->get_category_ids(), $product->get_price());
    }
}
?>
<!--  SG Paiement en plusieurs fois -->
