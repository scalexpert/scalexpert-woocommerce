	...
	class SettingController {
		...
		public function title_callback() : void {
			printf(
				...
				isset( $this->sg_scalexpert_configurable_settings['title'] ) ? esc_attr( $this->sg_scalexpert_configurable_settings['title'] ) : ''
			);
		...
		public function description_callback() : void {
			printf(
				...
				isset( $this->sg_scalexpert_configurable_settings['description'] ) ? esc_attr( $this->sg_scalexpert_configurable_settings['description'] ) : ''
			);
