	...
	class AdminController {
		...
		public static function getAdministrationTopMenu(string $activeTab = self::PAGE_NAME) {
			...
			<nav class="nav-tab-wrapper woo-nav-tab-wrapper">
				<a href="./admin.php?page=sg-scalexpert-keys" class="nav-tab <?php echo ($activeTab === self::PAGE_NAME) ? "nav-tab-active" : ""; ?>"><?= __( "Setting the keys", "woo-scalexpert" ) ?></a><a
					href="./admin.php?page=sg-scalexpert-debug" class="nav-tab <?php echo ($activeTab === DebugController::PAGE_NAME) ? "nav-tab-active" : ""; ?>"><?= __( "Mode debug", "woo-scalexpert" ) ?></a><a
					href="./admin.php?page=sg-scalexpert-finances" class="nav-tab <?php echo ($activeTab === FinancingController::PAGE_NAME) ? "nav-tab-active" : ""; ?>"><?= __( "Activate / deactivate", "woo-scalexpert" ) ?></a>
			</nav>
			<?php
		}
