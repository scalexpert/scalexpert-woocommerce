<?php
	...
	class FinancingController {
		...
		public function sg_scalexpert_financepage_init() {
			...
			/*add_settings_field(
				'group_financing_solution', // id
				__( 'Grouping payment methods', "woo-scalexpert" ), // title
				array( $this, 'group_financing_solution_callback' ), // callback
				'sg-scalexpert-finances', // page
				'sg_scalexpert_setting_section' // section,
			);*/
		...
		public function sg_scalexpert_sanitize( $input ) : array {
			...
			//if ( isset( $input['group_financing_solution'] ) ) {
			//	$sanitary_values['group_financing_solution'] = $input['group_financing_solution'];
