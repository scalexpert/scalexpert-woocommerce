<?php
	...
	class DesignController {
		 ...
		 *
		 */
		function sg_scalexpert_create_customisation_page() {
			?>
			<div class="wrap">
		 ...
		 *
		 */
		function sg_scalexpert_customisation_init() {
			register_setting(
		...
		function sg_scalexpert_customisation_sectionProduct() {
			add_settings_section(
		...
		function sg_scalexpert_customisation_sectionPaiement() {
			add_settings_section(
		...
		function sg_scalexpert_customisation_sectionGeneral() {
			add_settings_section(
